      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex justify-center mb-6 ">
          <nav className="flex flex-wrap justify-center gap-4 md:gap-8">
            ...
            <a className="text-gray-700 hover:text-pink-600 text-sm md:text-base font-medium cursor-pointer">Contact</a>
            <a className="text-gray-700 hover:text-pink-600 text-sm md:text-base font-medium cursor-pointer">Jobs</a>
            <a className="text-gray-700 hover:text-pink-600 text-sm md:text-base font-medium cursor-pointer">Press kit</a>
          </nav>
        </div>
