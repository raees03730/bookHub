    ...
    <>
      ...
      <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${
        ...
        <div className="navbar h-16">
          ...
          {/* ✅ ALL ITEMS IN ONE ROW - Navigation + Search + Moon + Login (THODA RIGHT & THODA BADA) */}
          <div className="navbar-center hidden lg:flex items-center gap-3">
            ...
            {/* ✅ SEARCH BOX, MOON ICON & LOGIN - About ke right side pe (THODA RIGHT & THODA BADA) */}
      ...
      {/* Contact Form Section - Add margin-top for navbar space */}
