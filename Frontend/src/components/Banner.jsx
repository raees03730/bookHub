     ...
     <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-30">
        ...
        <div className="space-y-6 md:space-y-12">
            ...
            <p className=" text-sm md:text-xl">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi veniam nemo sint quaerat culpa optio, illo quibusdam odio quis eos laboriosam est nesciunt, omnis porro commodi temporibus magnam accusantium dolorem.
            </p>
        ...
        <div className="order-1 w-full md:w-1/2 md:ml-20 flex justify-center items-center ">
          <img src={banner} className=" w-full max-h-[300px] h-auto object-contain md:max-h-[500px] " alt="" />
        </div>
